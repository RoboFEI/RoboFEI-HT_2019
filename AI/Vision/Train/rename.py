...
for name in names:
#     print name
    sub = "sed -i 's/"+ name.replace("\ ", " ") +"/a"+ str(image).zfill(5) +"/g' ./Train/annotations/"+ name +".xml"
#     print sub
    os.system(sub)
    jpg = "mv ./Train/imagensTrain/"+ name +".jpg ./Train/imagensTrain/a"+ str(image).zfill(5) +".jpg"
#     print jpg
    os.system(jpg)
    xml = "mv ./Train/annotations/"+ name +".xml ./Train/annotations/a"+ str(image).zfill(5) +".xml"
#     print xml
    os.system(xml)
#     raw_input()
    image +=1
