...
# Implementas as tecnicas de usadas pela equipe RoboFEI para a detecção da bola## Bibliotecas usadas
...
|			 cv2.cv as cv			 |  OpenCV - Usada para usufluir de algumas funções mais antigas  |
